...
<body>
        ...
        <table style="width:100%; table-layout:fixed">
            <tr>
                ...
                <td width='80%'>: <?php echo tgl_indo($detail->tanggal_keluar)?></td>
            </tr>
        </table>
        <table style="width:100%; table-layout:fixed">
            <tr>
                <td width='20%'>Keterangan</td>
                <td width='80%'>: <?php echo $detail->keterangan ?></td>
            </tr>
        </table>
        <table style="width:100%; table-layout:fixed">
            <tr>
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="5">
            ...
            <tbody>
            <?php
                foreach ($detailstok as $ds) {
                    ?>
                <tr>
                    <td><?php echo $ds->nama_barang?></td>
                    <td style= "text-align: center;"><?php echo $ds->jumlah_keluar?></td>
                    <td><?php
                        foreach ($satuan as $st) {
                            ?>
                            <?php
                            if($ds->satuan_id == $st['id']) {
                                ?>
                    <?php echo $st['nama_satuan']?></td>     
                    <?php } ?>          
                    <?php } ?></td>
                </tr>
                <?php } ?>
